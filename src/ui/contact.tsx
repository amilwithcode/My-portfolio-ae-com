            ...
            <section className="max-w-lg mx-auto p-8 border rounded-lg shadow-lg">
                ...
                <form ref={form} onSubmit={handleSubmit} className="space-y-6 flex flex-col gap-10">
                    <div className="flex flex-col">
                        <label htmlFor="name" className="text-sm font-medium text-gray-700">Adınız</label>
                        <input
                            type="text"
                            id="name"
                            name="name"
                ...
                {status && (
                    <p className={`mt-4 text-center font-semibold ${status.includes('uğurla') ? 'text-green-500' : 'text-red-500'}`}>
                        {status}
                    </p>
                )}
            </section>
